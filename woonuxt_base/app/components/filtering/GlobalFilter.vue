...
<template>
  <div class="cursor-pointer flex font-semibold mt-1 leading-none justify-between items-center text-gray-900" @click="isOpen = !isOpen">
  ...
  <div v-show="isOpen" class="mt-3 mr-1 max-h-60 grid gap-1 overflow-auto custom-scrollbar">
    <div v-for="term in attribute.terms" :key="term.slug" class="flex gap-2 items-center">
      ...
      <label :for="term.slug" class="cursor-pointer m-0 text-sm flex items-center flex-wrap text-gray-700">
