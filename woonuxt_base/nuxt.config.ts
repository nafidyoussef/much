...
export default defineNuxtConfig({
  ...
  nitro: {
    prerender: {
      // Netlify Image CDN URLs are generated by @nuxt/image and resolved by
      // Netlify at runtime. During prerender, Nitro's crawler sees them as
      // internal links and reports false 404s.
